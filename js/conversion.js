            ...
            OCA.Files.fileActions.registerAction({
                ...
                actionHandler: function (filename, context) {
                    ...
                    $('#linkeditor').append(
                        ...
                        + '<option value="none">Auto</option>'
                        + '<option value="1">96k</option>'
                        + '<option value="2">128k</option>'
                        + '<option value="3">160k</option>'
                        + '<option value="4">192k</option>'
                        + '<option value="5">224k</option>'
                        + '<option value="6">256k</option>'
                        + '<option value="7">320k</option>'
                        + '</select>'
